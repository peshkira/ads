 ...
 * @version $Id: TestProviderTotalOrder.java 10:a79260987421 2010/03/30 11:05:00 Lorenz Froihofer $
 */
public class TestProviderTotalOrder implements TestProvider {
  private static Log log = LogFactory.getLog(TestProviderTotalOrder.class);
